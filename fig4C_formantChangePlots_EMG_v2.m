...
clear all; close all
addpath('/Users/zira/Library/CloudStorage/Dropbox/github/monkey_proprioception')
%load('allCutVowelPhonemes_Subject001+Subject004_20240319.mat');
%load('C:\Users\emg27\Dropbox\PostDoc\ElviraMarco\One-on-One\20241121\datPhoneme_allVowels_20241120.mat')
load("/Users/zira/Library/CloudStorage/Dropbox/PostDoc/ElviraMarco/One-on-One/20241121/datPhoneme_allVowels_20241120.mat")
        ...
        if vs==formantsOFF{testVS,1,dayii} % phoneme name is the same for OFF and ON
            ...
            if cond == "No Stim"
                ...
                elseif sub(ph).trl == 1 
                   ...
                   % trial 1 data (across days, formants, etc.)
                    ...
                    formantsOFF{testVS,2,dayii} = [formantsOFF{testVS,2,dayii} f1];%mean(f1)];
                    formantsOFF{testVS,3,dayii} = [formantsOFF{testVS,3,dayii} f2];%mean(f2)];
            ...
            elseif cond == onCond
                ...
                elseif sub(ph).trl == 1
                    ...
                    formantsON{testVS,2,dayii} = [formantsON{testVS,2,dayii} f1];%mean(f1)];
                    formantsON{testVS,3,dayii} = [formantsON{testVS,3,dayii} f2];%mean(f2)];
